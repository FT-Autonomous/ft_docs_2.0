...
**The mount used for the FSAI is comprised of the following equipment:**  
...
- Modem ([TP Link Archer C50 (EU)](modem.md), new for 25/26)  
...
- Stand for Zed2i  
- Weatherproof housing (dubbed '[Lunchy](lunchy.md)')  
- Rack for housing computational equipment  